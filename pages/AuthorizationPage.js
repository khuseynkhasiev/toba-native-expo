...
const Authorization = ({ route, navigation }) => {
    ...
    const [loginTextIsError, setLoginTextIsError] =
        useState("Обязательное поле");
            ...
            .then((isEmail) => {
                ...
                if (!isEmail) {
                    ...
                    setEmailErrorInputText(
                        "На этой почте не зарегистрирован аккаунт"
                    );
                } else {
                        ...
                        <View style={styles.authorization__formContainer}>
                            ...
                            {isActiveAuthorization ? (
                                <>
                                    ...
                                    <TouchableOpacity
                                        style={
                                            styles.authorization__btnContainer
                                        }
                                        title="Войти"
                                        onPress={() =>
...
*/}
                                ...
                                <>
                                    <View
                                        style={
                                            styles.authorization__nameInputBlock
                                        }
                                    >
                                        <TextInput
                                            style={[
                                    ...
                                    <View
                                        style={
                                            styles.authorization__containerBtn
                                        }
                                    >
                                        <TouchableOpacity
                                            style={
                        ...
                        <View style={styles.authorization__footerLine}>
                            ...
                            <View
                                style={styles.authorization__lineRight}
                            ></View>
                        </View>
