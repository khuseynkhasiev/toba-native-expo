...
export default function NewCityScene({ navigation }) {
    ...
    const prepare = async () => {
        try {
            await video.current.loadAsync(require("../../assets/video/new-city.mp4"));
    ...
    const backScene = () => {
        //resetIsActiveDialog();
        unloadVideo();
        navigation.navigate('RegenerationScene');
    };
    const nextScene = () => {
        //resetIsActiveDialog();
        unloadVideo();
    ...
    return (
        <Animated.View style={[styles.container, { opacity: fadeAnimOpacity }]}>
            ...
            />
            {
                isActiveDialog && <Text style={styles.dialog}>Они создали другой мир и начали править</Text>
            }
