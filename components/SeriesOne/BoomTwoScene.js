...
export default function BoomTwoScene({ navigation }) {
    ...
    const prepare = async () => {
        try {
            await video.current.loadAsync(require("../../assets/video/boom-two.mp4"));
    ...
    return (
        <Animated.View style={[styles.container, { opacity: fadeAnimOpacity }]}>
            ...
            />
            {
                isActiveDialog && <Text style={styles.dialog}>Мир погруженный в абсолютный ХАОС</Text>
            }
