  ...
  return (
    <SafeAreaView style={styles.profile}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.profile__seriesBtn}
        ...
        <View style={styles.profile__form}>
            ...
            <View style={styles.profile__formTopBlock}>
              <View style={styles.profile__userImageTop}>
                {userData.avatar === null || userData.avatar === undefined ? (
                  <View
                    style={styles.profile__imageCircle}
                    source={require("../assets/image/profileCircLeImage.png")}
                  >
                  ...
                  <Image
                    ...
                    source={{
                      uri: `https://animics.ru/storage/${userData.avatar}`,
                    }}
                  />
                )}
              </View>
                      ...
                      <>
                        {loadingConfirmProfile ? (
                          ...
                          <View style={styles.profile__lineBlock}>
                            <Text style={styles.profile__textLine}>
                              *нет подтверждения/{" "}
                            </Text>
                            <TouchableOpacity
                              onPress={() => handleEmailVerify()}
                            >
                              <Text style={styles.profile__textLine_underline}>
                                отправить повторно?
                              </Text>
                            </TouchableOpacity>
                          </View>
          ...
          <TouchableOpacity
            style={styles.profile__editBtn}
            onPress={() => navigation.navigate("ProfileEdit")}
          >
            <ProfileEditSvgIcon />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.profile__exitBtn}
            onPress={() => setPopupExitIsActive(true)}
          >
            <ImageBackground
              style={styles.profile__exitImageBg}
              source={require("../assets/image/iconEditBtnCircle.png")}
            >
              <ProfileExitSvgIcon />
            </ImageBackground>
          </TouchableOpacity>
      ...
      {popupExitIsActive && (
        <PopupExit
          ...
          setPopupExitIsActive={setPopupExitIsActive}
        />
      )}
      {popupVerifyIsActive && (
        <PopupVerify
          message={popupVerifyMessage}
          setPopupVerifyIsActive={setPopupVerifyIsActive}
        />
      )}
    </SafeAreaView>
  );
