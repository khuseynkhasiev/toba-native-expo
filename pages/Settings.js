...
const Settings = ({ navigation }) => {
    ...
    const openPopupTemporarily = () => {
        setPopupTemporarily(true);
    };
    ...
    return (
        <SafeAreaView style={styles.settings}>
            <View style={styles.settings__container}>
                <ImageBackground
                    style={styles.settings__background}
                    source={require("../assets/image/settingBackground.png")}
                >
                    {popupConfirmedDeleteIsActive && (
                        <PopupConfirmedDeleteAccount
                    ...
                    <View style={styles.settings__backgroundContainer}>
                        <ImageBackground
                            style={styles.settings__form}
                            source={require("../assets/image/settingsBgContainer.png")}
                        >
                            ...
                            <View style={styles.settings__row}>
                                <View style={styles.settings__leftBlock}>
                                    <View
                                        style={styles.settings__containerText}
                                    >
                                        <View
                                            style={
                                                styles.settings__containerCheck
                                            }
                                        >
                                            <Text
                                                style={
                                                    styles.settings__leftText
                                                }
                                            >
                                                Звук/Вкл
                                            </Text>
                                    ...
                                    <TouchableOpacity
                                        style={styles.settings__learnComicsBtn}
                                        onPress={() => openPopupTemporarily()}
                                    >
                                        <PlayButtonSvgIcon />
                                        <Text
                                            style={
                                                styles.settings__learnComicsText
                                            }
                                        >
                                ...
                                <View style={styles.settings__rightBlock}>
                                    <View
                                        style={styles.settings__rightBlockTop}
                                    >
                                        <TouchableOpacity
                                        ...
                                        <TouchableOpacity
                                            style={styles.settings__card}
                                            onPress={() =>
                                                openPopupConfirmedDeleteAccount()
                                            }
                                        >
                                            <DeleteAccountButtonSvgIcon />
                                            <Text
                                    ...
                                    >
                                        <TouchableOpacity
                                            ...
                                            onPress={() =>
                                                Linking.openURL(
                                                    "https://pay.cloudtips.ru/p/b7d425cd"
                                                )
                                            }
                                        >
                                            <HelpProjectButtonSvgIcon />
                ...
                <TouchableOpacity
                    style={styles.settings__menuBtn}
                    onPress={() => navigation.navigate("Main")}
                >
                    <MenuBackSvgIcon />
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.settings__profileBtn}
