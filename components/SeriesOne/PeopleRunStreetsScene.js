...
export default function PeopleRunStreetsScene({ navigation }) {
    ...
    const prepare = async () => {
        try {
            await video.current.loadAsync(require("../../assets/video/people-run-streets.mp4"));
    ...
    return (
        <Animated.View style={[styles.container, { opacity: fadeAnimOpacity }]}>
            ...
            />
            {
                isActiveDialog && <Text style={styles.dialog}>Выстроили свои законы и люди подчинились Им</Text>
            }
